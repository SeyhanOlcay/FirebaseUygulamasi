...
import com.example.toshba.firebaseuygulamasi.Adapter.CustomAdapter;
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    Mesaj message = ds.getValue(Mesaj.class);
                    chatLists.add(message);
                    //Log.d("VALUE",ds.getValue(Mesaj.class).getMesajText());
                }
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (inputChat.getText().length() >= 6) {
                    ...
                    Mesaj message = new Mesaj(inputChat.getText().toString(), fUser.getEmail(), dateTime);
